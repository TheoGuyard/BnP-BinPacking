...
The three heuristics implemented are the \textit{First-Fit} (FFD), the \textit{Best-Fit} (BFD) and the \textit{Worst-Fit} (WFD) algorithm and they select the bin to pack the item as following :
\begin{itemize}
